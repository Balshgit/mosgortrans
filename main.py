...
cron_jobs = [
        {'trigger': 'cron', 'day_of_week': 'mon-fri', 'hour': 21, 'minute': 11, 'second': 0},
        {'trigger': 'cron', 'day_of_week': 'mon-fri', 'hour': 21, 'minute': 12, 'second': 0},
        {'trigger': 'cron', 'day_of_week': 'mon-fri', 'hour': 21, 'minute': 13, 'second': 0},
    ]
